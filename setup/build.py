...
def input_gate() -> None:
    """Every fail-closed gate, in order — the suite lives in setup/gates.py
    (THE STRUCTURE LAW, 2026-08-12). It borrows this module's `step` and `run`
    so the console's voice and the subprocess policy stay in one place."""
    from gates import input_gate as run_gates
    run_gates(step, run)

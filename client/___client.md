...
| `load_test.js` | Standard | dev harness — concatenates and executes the 16 client scripts below, in load order, against a stubbed DOM to catch load-time errors — [about](__about/load_test.md) |

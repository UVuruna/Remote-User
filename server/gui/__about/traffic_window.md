...
**Split 2026-08-18 (THE STRUCTURE LAW, VC-R4)** — the fourth cut off this
window, and by responsibility as every one before it:
[Traffic Spans](traffic_spans.md) owns which stretch of the recording a span
name means and how a zoomed view keys its read;
[Traffic Legend](traffic_legend.md) owns the drawn colour swatch.

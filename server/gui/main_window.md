...
- **Settings card** — monitor, resolution cap, bitrate, frame rate, phone hand (right/left — the client's cursor-offset diagonal); **Apply & restart** persists via `save_user_settings()` and restarts the server

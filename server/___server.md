...
| `traffic_devices.py` | Standard | which PHONE the traffic belongs to — a resolution-keyed identity, a persisted colour slot, session-length/rate arithmetic — [about](__about/traffic_devices.md) |

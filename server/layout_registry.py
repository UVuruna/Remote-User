...
class LayoutRegistry:
    ...
    def state(self, active: int | None, region: dict | None) -> dict:
        """The `layout_state` payload — see `layout_state.py`, which owns what
        the phone is told about these layouts (this file owns the windows)."""
        return layout_state.state(self, active, region)
